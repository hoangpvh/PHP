        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <?php
                        if(isset($_GET['appdate']) && isset($_GET['doc_id']) && isset($_GET['patient_id'])){
                            $appdate = $_GET['appdate'];
                            $doc_id=$_GET['doc_id'];
                            $patient_id = $_GET['patient_id'];
                            $query=mysqli_query($connect,"select * from prescribe where appdate_pre='$appdate' and doctor_id='$doc_id' and patient_id='$patient_id' ") ;                        
