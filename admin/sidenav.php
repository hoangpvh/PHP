...
<body>
    <div class="list-group bg-info" style="height: 150vh;">
        ...
        <a href="job_request.php" class="list-group-item list-group-item-action bg-info text-center text-white">Job Request</a>
        <a href="appointment.php" class="list-group-item list-group-item-action bg-info text-center text-white">Appointment</a>
        <a href="income.php" class="list-group-item list-group-item-action bg-info text-center text-white">Income</a>
