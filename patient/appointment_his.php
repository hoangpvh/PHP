    ...
    <div class="col-md-10 my-2">
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php                
                    $id = $_SESSION['patient'];
                    $query = "select * from appointment where patient_id='$id'order by appdate desc";
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        { ?>
	                        ...
	                        <a href="appointment_his.php?doc_id=<?php echo $row['doc_id']?>&appdate=<?php echo $row['appdate']?>&patient_id=<?php echo $row['patient_id']?>&cancel=update"
                        ...
                        {                      
                            ...
                            <a href="view.php?appdate=<?php echo $row['appdate']?>"><button class="btn btn-success">View</button></a>
                        <?php }?>
