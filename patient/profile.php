                            ...
                            <div class="col-md-6">                            
                                ...
                                <?php
                                    if(isset($_POST['change'])){
                                        ...
                                        if(empty($name)){
                                            ...
                                            $query="UPDATE patient SET name='$name' WHERE email='$email'";
                                            $res = mysqli_query($connect,$query);
                                            if($res){
                                ...
                                <?php
                                        if(isset($_POST['update_pass'])){
                                            ...
                                            $old = mysqli_query($connect,"SELECT *FROM patient WHERE email='$email'");
                                            ...
                                            if(empty($old_pass)){
                                                ...
                                                if(count($error) == 0){
                                                    $query = "UPDATE patient SET password='$new_pass' WHERE email='$email'";
                                ...
                                <form action="" method="post">
                                    ...
                                    <input type="submit" name="update_pass" id="" value="Change Password" class="btn btn-success">
                                </form>
                            </div>
                        </div>
                    </div>
